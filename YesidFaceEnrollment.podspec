...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of YesidFaceEnrollment.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Emmanuel Mtera/YesidFaceEnrollment'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Emmanuel Mtera' => '114977026+vijanatech@users.noreply.github.com' }
  s.source           = { :git => 'https://github.com/Emmanuel Mtera/YesidFaceEnrollment.git', :tag => s.version.to_s }
